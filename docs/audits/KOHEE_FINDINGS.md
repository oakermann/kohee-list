...
| KF-2026-05-09-005 | LOW    | Governance         | Direct Codex Cloud docs-only PR publishing smoke test executed to verify actual GitHub PR URL creation for `oakermann/kohee-list`.                                                               | Yes              | FIXED 2026-05-09 | PR (this smoke test) |
